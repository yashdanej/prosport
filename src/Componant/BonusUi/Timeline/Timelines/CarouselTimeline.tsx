...
import { Badges, H4, Image, P } from '../../../../AbstractElements';
...
const CarouselTimeline = () => {
  ...
  return (
    <VerticalTimelineElement className='cd-timeline-block' date='April 23 2022' icon={<i className="icon-image"></i>} iconClassName='cd-timeline-img bg-success'>
