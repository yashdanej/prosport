...
import { CssRibbons, RibbinLeftText2 } from '../../../../utils/Constant';
  ...
  return (
    <Col sm="6" xl="4">
      <div className="ribbon-wrapper border border-1 height-equal alert-light-light">
        ...
        <P>
          <em className="txt-danger">{ribbonLeftTextEm}</em>{ribbonLeftText1}<em className="txt-danger">{CssRibbons}</em>{RibbinLeftText2}
        </P>
      </div>
    </Col>
  )
