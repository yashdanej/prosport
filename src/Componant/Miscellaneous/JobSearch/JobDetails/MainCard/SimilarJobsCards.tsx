...
import { SimilarJobsCardsType } from '../../../../../Types/JobSearch/JobSearch';
              ...
              <div className="job-search">
                <CardBody>
                  <div className="d-flex">
                    <Image className="img-40 b-r-0 img-fluid m-r-20" src={dynamicImage(`${item.logo}`)} alt=""/>
                    <div className="flex-grow-1">
                      ...
                      <P>
                        ...
                        <Rating className="ms-1" fillColor={"#D77748"} initialValue={Math.random() * 5} size={14}/>
                      </P>
                    </div>
                  </div>
