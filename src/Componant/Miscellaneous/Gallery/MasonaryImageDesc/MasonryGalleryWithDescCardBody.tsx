...
import { masonryImageData } from '../../../../Data/Gallery/Gallery';
                    ...
                    <Item original={dynamicImage(element.src)} width="700" height="850">
                      {({ ref, open }) => (
                        <Link to={Href} onClick={open}>
                          <img className="img-thumbnail p-2 rounded-0 rounded-top-1" ref={ref as React.MutableRefObject<HTMLImageElement>} src={dynamicImage(element.src)} alt="images" />
