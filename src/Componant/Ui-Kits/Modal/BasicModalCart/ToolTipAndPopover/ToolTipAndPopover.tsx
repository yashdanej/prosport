...
import { ButtonSmall, Href, PopoverModal, TooltipsAndPopovers, TooltipsModal } from '../../../../../utils/Constant';
    ...
    <>
      ...
      <CommonModal isOpen={toolAndPopover} toggle={tooltipsAndPopoversToggle} title="Tooltip and Popover Moda">
        ...
        <P className="mt-2">{`This `}
          <Btn color="success" className="popover-test" id="Tooltip-ModalBtnProp" title="this is amazing content">{ButtonSmall}</Btn>{` triggers a popover on click.`}
        </P>
        <hr />
        <H5>{TooltipsModal}</H5>
        <P className="mt-2">
