...
import { Simple } from '../../../../utils/Constant';
      ...
      <Modal isOpen={simpleModal} toggle={toggle}>
        <ModalBody>
          <div className="modal-toggle-wrapper">
            ...
            <Btn color="primary" className="d-flex align-items-center gap-2 text-light ms-auto" onClick={toggle}>Explore More <ArrowRight /></Btn>
          </div>
        </ModalBody>
      </Modal>
    </>
