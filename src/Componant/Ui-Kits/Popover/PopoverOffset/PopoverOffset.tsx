...
import { PopoverOffset50, PopoverOffsets } from '../../../../utils/Constant';
    ...
    <Col sm="12">
      <Card>
        ...
        <CardBody className="common-flex popover-wrapper">
          ...
          <Popovers placement="right-start" isOpen={popover} target="Popover-8" toggle={toggle} title={PopoverOffset50}>
