import { ButtonGroup, DropdownItem, DropdownMenu, DropdownToggle, FormGroup, Input, Label, UncontrolledDropdown } from "reactstrap";
import { DefaultButtonsTitle, Href } from "../../../../utils/Constant";
import { Alerts, Badges, Btn, P, Progressbar } from "../../../../AbstractElements";
import { Link } from "react-router-dom";
import AlertsWithIcons from "../../../../Componant/Tables/ReactstrapTable/TableComponent/Common/AlertsWithIcons";
import DismissibleAlerts from "../../../../Componant/Tables/ReactstrapTable/TableComponent/Common/DismissibleAlerts";
    ...
    tableColData: (
      <Alerts color="primary">
        <P>
          ...
          <Link className="alert-link" to={Href}>
            {" "}
            read this message
          </Link>
          .
...
export const progressTableData = [
  ...
  },
  {
    ...
    tableColData: <Progressbar color="primary" className="lg-progress-bar" value={75} />,
    details: [
      {
...
export const tooltipTableData = [
  {
    title: "Hover",
    tableColData: (
      <Btn color="primary" data-original-title="btn btn-link btn-lg" title="Hover">
        Primary
      </Btn>
    ),
    details: [
